...
class DeviceDetectionOnPremise extends Engine
{
     ...
     *
     * @return \fiftyone\pipeline\core\BasicListEvidenceKeyFilter
     */
     ...
     *
     * @param null|mixed $fileName_or_data data file path or the variable holding the in-memory data file
    ...
    public function refreshData($fileName_or_data = null, $length = null)
    {
        switch (func_num_args()) {
            case 0:
                ...
                break;
            case 1:
                $this->engine->refreshData($fileName_or_data);
                break;
            default:
